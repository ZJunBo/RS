...
source_dir = dict(
    image_dir=[
        './MUCSS/Train/PotsdamIRRG/images/',
    ],
    mask_dir=[
        './MUCSS/Train/PotsdamIRRG/labels/',
    ],
)
target_dir = dict(
    image_dir=[
        './MUCSS/Val/Vaihingen/images/',
    ],
    mask_dir=[
        './MUCSS/Val/Vaihingen/masks/',
    ],
)
test_target_dir = dict(
    image_dir=[
        './MUCSS/Test/Vaihingen/images/',
    ],
    mask_dir=[
        './MUCSS/Test/Vaihingen/masks/',
    ],
)
